...
/*
 *Nome da funcao: FASE1
 *
 * Objetivo da funcao:  ler o ficheiro de entrada, criar o ficheiro de saida, aplicar restrições relevantes e juntar as funções que garantem o bom funcionamento da fase 1
 * 
 ...
 *Nome da funcao: A1
 *
 * Objetivo da funcao: Implementa o modo A1
 * 
 * Argumentos de entrada:
 *          L : numero maximo de linhas
 *          C : numero maximo de colunas
 *          lIMP : numero da linha que se quer avaliar
 *          cIMP : numero da coluna que se quer avaliar
 ...
 *          -1 : casa preta
 *           0 : casa branca
 *           nmr real superior a 0 : casa cinzento com esse custo
 * 
 */ 
 ...
 *Nome da funcao: A234
 *
 * Objetivo da funcao: Implementa o modo A2, A3 e A4
 * 
 * Argumentos de entrada:
 *          L : numero maximo de linhas
 *          C : numero maximo de colunas
 *          l : numero da linha que se quer avaliar
 *          c : numero da coluna que se quer avaliar
 *          *maze : ponteiro para o labirinto
 *          v : modo de funcionamento (1 : A3 | 0 : A2 | -1 : A4)
 * 
 * Argumentos de saida:
 *          -2 : fora do labirinto
 *           1 : tem pelo menos um vizinho do tipo pedido
 *           0 : não tem vizinhos do tipo pedido
 * 
 */ 
 ...
 *Nome da funcao: A5
 *
 * Objetivo da funcao: Implementa o modo A5
 * 
 * Argumentos de entrada:
 *          L : numero maximo de linhas
 *          C : numero maximo de colunas
 ...
 *Nome da funcao: A6
 *
 * Objetivo da funcao: Implementa o modo A6 com recurso a uma implemtção do DFS
 * 
 * Argumentos de entrada:
 *          L : numero maximo de linhas
 *          C : numero maximo de colunas
 *          linit : linha da casa inicial
 *          cinit : coluna da casa inicial
 *          lend : linha da casa final
 *          cend : coluna da casa final
 *          *maze : ponteiro para o labirinto
 * 
 * Argumentos de saida:
 *          -2 : fora do labirinto
